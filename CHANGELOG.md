...
### Fixed
<!-- Bug fixes go here -->
- Pasting or dropping an image into a session whose agent provider does not take attachments now says so, instead of sending a file reference the agent never receives.
